...
fallbackToggle.className = 'dysonrepair-chat-fallback';
fallbackToggle.setAttribute('aria-label', 'Abrir chatbot DysonRepair');
...
if (target && !target.dataset.dysonrepairChatInitialized) {
  target.dataset.dysonrepairChatInitialized = 'true';
